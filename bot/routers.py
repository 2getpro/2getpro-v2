...
def build_root_router(settings_obj: Settings) -> Router:
    ...
    admin_filter_instance = AdminFilter(admin_ids=settings_obj.ADMIN_IDS)
...
def setup_routers(dp: Dispatcher) -> None:
    ...
    root_router = build_root_router(settings)
